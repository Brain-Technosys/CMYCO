...
public class GameActivity extends AppCompatActivity {
    ...
    private void setDefenceCat() {
        ...
        for (int i = 0; i < catDefenceArrayList.size(); i++) {
            ...
            catRadioButtons[i].setId(Integer.parseInt(catDefenceArrayList.get(i).get(Const.KEY_ID)));
            catRadioButtons[i].setText(catDefenceArrayList.get(i).get(Const.KEY_NAME));
