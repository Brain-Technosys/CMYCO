...
public class HomeActivity extends MyBaseActivity {
    ...
    ArrayList<HashMap<String, String>> arrayListCoach = new ArrayList<>();
    ...
    ArrayList<HashMap<String, String>> listCoachTeamDetail = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ((getIntent().hasExtra("TeamCoachDetail"))) {
            listCoachTeamDetail = (ArrayList<HashMap<String, String>>) getIntent().getSerializableExtra("TeamCoachDetail");
        }
...
//        };
    ...
    private void setTeamSpinner(int pos) {


        HashMap<String, String> hashMapTeam = new HashMap<>();

        hashMapTeam.put(Const.KEY_ID, listCoachTeamDetail.get(pos).get(Const.KEY_ID));
        hashMapTeam.put(Const.KEY_NAME, listCoachTeamDetail.get(pos).get(Const.KEY_NAME));
    ...
    private void setCoachSpinner() {
        ...
        for (int i = 0; i < listCoachTeamDetail.size(); i++) {
            HashMap<String, String> hashMapCoach = new HashMap<>();

            hashMapCoach.put(Const.KEY_ID, listCoachTeamDetail.get(i).get(Const.KEY_ID));
            hashMapCoach.put(Const.KEY_NAME, listCoachTeamDetail.get(i).get(Const.KEY_COACH));
...
//            }
            ...
            teamId = String.valueOf(arrayListTeam.get(pos).get(Const.KEY_ID));
